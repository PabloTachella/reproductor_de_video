...
//Utilizamos el patrón de diseño Singleton con un constructor privado y un método getInstance público
class Ads {
    ...
    private initAds() {
        ...
        this.ads = [...ALL_ADS] //creo una copia del array (si igualo directamente al modificar uno afecto a ambos)
    }
